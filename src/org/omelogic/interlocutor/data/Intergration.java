...
public class Intergration implements Serializable 
{
	
	
	private Map<String, Grater> annocols;
	...
	public Intergration(String[] argQueryIDs, boolean argParsedQueryAnnos, boolean argTrackPrefixAppended)
	{
		this.queryIDs = argQueryIDs;
		controlIDs = new String[0][];
		
		annocols = new HashMap<String, Locutus>();	
