...
public class Intergrater
{
	...
	public Intergrater(LocusSet argQSet, HLDBManager dbmLink, boolean argParseQueryAnnos, boolean argAddTrackPrefix) throws Exception
	{
